...
dataset = DataSet(embeddings, Config.get_filepath('train-data'), y_labels=['brand', 'model', 'memory', 'color', 'network', 'year'])
...
test = X_test[1500:2000]
expected = y_test[1500:2000]
